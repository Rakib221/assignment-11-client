...
let [loggedInUser,setLoggedInUser]=useContext(userContext)
    ...
    useEffect(() =>{
        fetch("https://arcane-springs-22787.herokuapp.com/showOrder")
      ...
      let  handleDelete=(id)=>{
        ...
        fetch(`https://arcane-springs-22787.herokuapp.com/deleteUserOrder/${id}`,{
          method:"DELETE"
...
fetch("https://arcane-springs-22787.herokuapp.com/update",{
    method:'PATCH',

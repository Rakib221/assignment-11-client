...
let [minusCount,setMinusCount]=useState(true)
  ...
  const [checkCard,setCheckCard]=useState([])
   ...
   let  {serviceTitle,price,img,description,_id,category} =Card||{}
    ...
    useEffect(() =>{
        fetch('https://arcane-springs-22787.herokuapp.com/showservices')
        .then(res=>res.json())
        .then(data=>{
          setCheckCard(data)
        })
    ...
    fetch("https://arcane-springs-22787.herokuapp.com/addorder",{
       method:'POST',
...
<div class="mb-3 w-75">
  <label for="exampleFormControlInput1" class="form-label">Address</label>
   ...
   <input   className="mb-5  submit-bt"  value="Confirm Order" type="submit" />
